...
namespace OBeautifulCode.Reflection
{
    ...
    static partial class ReflectionHelper
    {
        ...
        public static bool HasField(this object item, string fieldName, BindingFlags bindingFlags = DefaultBindingFlags) => GetFieldInfo(item?.GetType(), fieldName, bindingFlags) != null;
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms", MessageId = "Flags", Justification = "Correct name.")]
        public static IReadOnlyCollection<string> GetFieldNames(this Type type, BindingFlags bindingFlags = DefaultBindingFlags)
        {
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Globalization", "CA1305:SpecifyIFormatProvider", MessageId = "System.String.Format(System.String,System.Object,System.Object)", Justification = "This is a developer-facing string, not a user-facing string.")]
        private static T GetFieldValue<T>(this FieldInfo fi, object item)
        {
            if (fi == null)
            {
