...
namespace OBeautifulCode.Reflection.Recipes
{
    ...
    static partial class ReflectionHelper
    {
        ...
        /// <summary>
        /// Determines if the specified property is a getter-only property.
        /// </summary>
        /// <param name="propertyInfo">The property.</param>
        /// <returns>
        /// true if the specified property is a getter-only property, otherwise false.
        /// </returns>
        public static bool IsGetterOnlyProperty(
            this PropertyInfo propertyInfo)
        {
            ...
            if (propertyInfo.GetSetMethod(true) == null)
            {
                ...
                if (propertyInfo.GetGetMethod(true).IsCompilerGenerated())
                {
                    result = true;
                }
            }
